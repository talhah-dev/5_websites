...
## SITE 1 — APEX RESEARCH LABS

**Domain:** apex-researchlab.com
**Vibe:** Clinical, pharmaceutical, hospital-clean. Mature, cautious researcher buyer.

| Element | Value |
|---|---|
| **Logo file** | `logo_1_apex_research.png` |
| **Primary color** | `#0A2540` (deep navy) |
| **Secondary color** | `#FFFFFF` (white) |
| **Accent color** | `#6B7B8C` (steel gray) |
| **Background** | `#FFFFFF` |
| **Heading font** | Playfair Display (serif) |
| **Body font** | Inter (sans-serif) |
| **Tagline** | Pharmaceutical-Grade Compounds |
| **Hero headline** | "Pharmaceutical-Grade Research Compounds. Independently Verified." |
| **Hero sub** | "Every batch tested by third-party labs. Every result published." |
| **Primary CTA** | "View Verified Compounds →" |
| **Trust line** | "Trusted by 12,000+ research professionals." |
| **Email gate offer** | "Get 15% off your first order + free HPLC report" |
| **Discount code** | `APEX15` |
| **Footer email** | contact@apex-researchlab.com |
| **Site slug** | `apex` |

**Visual style notes:** Lots of white space. Thin horizontal divider lines. No drop shadows. Buttons are solid navy with white text, square corners or 2px radius max. Imagery is clinical (lab equipment, vials, certificates).

---

## SITE 2 — VANTA BIO (vantacompounds.com)

**Domain:** vantacompounds.com
**Vibe:** Luxury, exclusive, expensive. Like a Swiss watch brand sells peptides.

| Element | Value |
|---|---|
| **Logo file** | `logo_3_vanta_bio.png` |
| **Primary color** | `#C9A961` (brushed gold) |
| **Secondary color** | `#000000` (pure black) |
| **Accent color** | `#1A1A1A` (charcoal) |
| **Background** | `#000000` (dark mode site) |
| **Heading font** | Cormorant Garamond (elegant serif) |
| **Body font** | Lato (thin sans-serif) |
| **Tagline** | The Standard for Advanced Compounds |
| **Hero headline** | "The Standard for Advanced Research Peptides." |
| **Hero sub** | "Quietly precise. Independently verified. Reserved for those who know." |
| **Primary CTA** | "Enter Collection →" |
| **Trust line** | "Independent labs. Verified purity. Discreet delivery." |
| **Email gate offer** | "Join the list — receive 15% off your first order" |
| **Discount code** | `VANTA15` |
| **Footer email** | contact@vantacompounds.com |
| **Site slug** | `vanta` |

**Visual style notes:** Ultra-minimal. Tons of black space. Thin gold lines as dividers. Tiny letter-spaced uppercase navigation. No bold or aggressive type. Hover states are subtle gold underlines. Imagery is moody, low-key, dark-product-on-black-velvet feel.

---

## SITE 3 — PURELINE PEPTIDES (pureline-research.com)

**Domain:** pureline-research.com
**Vibe:** Honest, transparent, simple. "Nothing to hide" trust play.

| Element | Value |
|---|---|
| **Logo file** | `logo_5_pureline.png` |
| **Primary color** | `#1B4332` (deep forest green) |
| **Secondary color** | `#FFFFFF` (white) |
| **Accent color** | `#F4F1EA` (soft cream) |
| **Background** | `#FFFFFF` |
| **Heading font** | DM Serif Display (heading) |
| **Body font** | DM Sans (body) |
| **Tagline** | Every Batch Tested. Every Result Published. |
| **Hero headline** | "Every Batch Tested. Every Result Published." |
| **Hero sub** | "We publish every COA. Read them before you buy." |
| **Primary CTA** | "See Test Results →" |
| **Trust line** | "Full transparency. Zero hidden specs." |
| **Email gate offer** | "Enter your email — get 15% off + access to all COAs" |
| **Discount code** | `PURE15` |
| **Footer email** | contact@pureline-research.com |
| **Site slug** | `pureline` |

**Visual style notes:** Lots of white space. Clean horizontal underline accents (the "pure line" motif). Imagery is natural — soft daylight, clean countertops, plain vials. Approachable but not cute. No gradients, no shadows, no flashy elements.

---

## SITE 4 — PEAKFORM COMPOUNDS (peakperformancecompounds.com)

**Domain:** peakperformancecompounds.com
**Vibe:** Athletic, masculine, performance-driven. Gym audience, body recomp crowd.

| Element | Value |
|---|---|
| **Logo file** | `logo_2_peakform.png` |
| **Primary color** | `#FF5722` (electric orange) |
| **Secondary color** | `#0D0D0D` (matte black) |
| **Accent color** | `#FFFFFF` (white) |
| **Background** | `#0D0D0D` (dark mode site) |
| **Heading font** | Oswald (condensed bold) |
| **Body font** | Roboto (sans-serif) |
| **Tagline** | Compounds for Serious Operators |
| **Hero headline** | "RESEARCH COMPOUNDS FOR SERIOUS OPERATORS." |
| **Hero sub** | "Performance-grade peptides. Lab-tested. Built for results." |
| **Primary CTA** | "SHOP THE STACK →" |
| **Trust line** | "Used by athletes, lifters, and biohackers." |
| **Email gate offer** | "Drop your email — get 15% OFF + the Stack Guide" |
| **Discount code** | `PEAK15` |
| **Footer email** | contact@peakperformancecompounds.com |
| **Site slug** | `peakform` |

**Visual style notes:** Dark background everywhere. Orange CTAs that POP. Sharp angular shapes, slight uppercase aggression in headings. Imagery is gym/performance/athletic (no drug imagery). Bold weighted fonts.
